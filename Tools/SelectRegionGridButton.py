...
class SelectRegionGridButton(QFrame, ToolsInterface):
    ...
    def createGridWidget(self, signal):
        ...
        self.selectRegionGridWidget.setGeometry(
            buttonGlobalPos.x() + self.selectRegionGridWidget.width(), 
            buttonGlobalPos.y() - self.selectRegionGridWidget.height(), 
            self.selectRegionGridWidget.width(), 
            self.selectRegionGridWidget.height()
        )
